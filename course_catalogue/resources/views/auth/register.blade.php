<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="flex items-center justify-end mt-4 mb-3">
            ...
            <button type="submit" class="btn-warning">{{ __('Register') }}</button>

        </div>
       <div class="mt-3">
        <a class="underline text-sm text-gray-600  text-white rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800" href="{{ route('login') }}">
