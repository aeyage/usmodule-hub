                            ...
                            <div>
                                ...
                                name="department_id"
                                    ...
                                    @foreach ($departments as $department)
                                        <option {{ $department->id == $course->department_id ? 'selected' : '' }} value="{{ $department->id }}">{{ $department->name }}</option>
                                    @endforeach
                            ...
                            <div>
                                ...
                                name="semester_id"
                                    ...
                                    @foreach ($semesters as $semester)
                                        <option {{ $semester->id == $course->semester_id ? 'selected' : '' }} value="{{ $semester->id }}">{{ $semester->name }}</option>
                                    @endforeach
                            ...
                            <div>
                                ...
                                name="unit_id"
                                    ...
                                    @foreach ($units as $unit)
                                        <option {{ $unit->id == $course->unit_id ? 'selected' : '' }} value="{{ $unit->id }}">{{ $unit->name }}</option>
                                    @endforeach
                        ...
                        <div class="mb-2">
                            <div>
                                ...
                                <textarea row="10" type="text" name="description"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="Description" required>{{ $course->description }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="mb-2">
                            <div>
                                ...
                                <textarea row="10" type="text" name="prerequisite"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="prerequisite" required>{{ $course->prerequisite }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="mb-2">
                            <div>
                                ...
                                <textarea row="10" type="text" name="grading_basic"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="Grading" required>{{ $course->grading_basic }}</textarea>
                            </div>
                        </div>
